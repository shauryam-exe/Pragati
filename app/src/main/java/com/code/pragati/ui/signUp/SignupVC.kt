...
class SignupVC : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        flexbox = findViewById(R.id.flexBoxVC)
        regET = findViewById(R.id.etRegVC)
        emailET = findViewById(R.id.etEmailVC)
        nameET = findViewById(R.id.etFullNameVC)
        setPassET = findViewById(R.id.etSetPassVC)
        confirmPassET = findViewById(R.id.etConfirmPassVC)
                ...
                firebaseAuth.createUserWithEmailAndPassword(email, setPass)
                    .addOnCompleteListener { task ->
                        if (task.isSuccessful) {
                            ...
                            FirebaseDatabase.getInstance().reference.child("Users").child("VC")
